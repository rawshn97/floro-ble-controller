...
| [specs/analytics.md](specs/analytics.md) | Microsoft Clarity events, filtering | `js/clarity.js` |
| [docs/ble-protocol.schema.json](docs/ble-protocol.schema.json) | BLE Nordic UART JSON schema | `js/protocol.js` |
...
| **PWA** | Installable at `/floro-remote/`; native install when the browser offers it |
| **Deploy** | Static files vendored into `rawshn-portfolio` `public/floro-remote/` |
...
| Date | Change |
|------|--------|
| 2026-09-05 | Rebrand to FloRo Remote, modular ES refactor, protocol schema |
